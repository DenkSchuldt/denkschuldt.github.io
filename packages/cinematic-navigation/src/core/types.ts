...
export type TransitionIntent =
  "scene" | "return" | "enter-focus" | "move-focus" | "exit-focus" | "route-sync" | "interrupt";
...
export interface CinematicEngineConfiguration<
  TFraming = unknown,
  TTransition = unknown,
  TResponsive = unknown,
> {
...
export interface CinematicEngine<TFraming = unknown, TTransition = unknown, TResponsive = unknown> {
  ...
  getScene(
    sceneId: NavigationId,
  ): SceneRegistration<TFraming, TTransition, TResponsive> | undefined;
  resolveSceneTransition(sceneId: NavigationId): SceneTransitionResolution<TTransition> | undefined;
  getFocusCollection(
    collectionId: NavigationId,
  ): FocusCollectionRegistration<TFraming, TTransition> | undefined;
  getFocusItem(
    collectionId: NavigationId,
    itemId: NavigationId,
