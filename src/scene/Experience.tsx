...
export default function Experience() {
  ...
  const controls = useControls("Cinematography", {
    ...
    paperPosition: { value: { x: -1.28, z: 0.62 }, step: 0.01, label: "Paper position" },
    paperRotation: { value: -4, min: -15, max: 15, step: 1, label: "Paper rotation Y" },
    penPosition: { value: { x: -0.13, z: 0.16 }, step: 0.01, label: "Pen position" },
    penRotation: { value: 25, min: -45, max: 45, step: 1, label: "Pen rotation Y" },
