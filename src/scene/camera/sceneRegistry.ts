...
export const SCENE_REGISTRY:Record<SceneId,SceneDefinition>={
  ...
  projects:{id:"projects",label:"Projects",route:"/projects",subject:"laptop",cameraTarget:"projects",framing:framing([.35,2.06,3.52],[-.55,1.76,-1.9],37),cameraFocus:{enabled:true,focusDistance:.02,focusTarget:"laptop-screen"},transition:{duration:4.8,arrivalDelay:.12,breathing:quietBreathing},responsive:{mobile:{position:[.15,2.25,4.45],lookAt:[-.45,1.72,-1.82],fov:45},tablet:{position:[.45,2.16,3.9],fov:40}},focusCollection:"projects"},
  ...
  poems:{id:"poems",label:"Poems",route:"/poems",subject:"folder",cameraTarget:"poems",framing:framing([2.1,3.55,.25],[1.55,1.26,-.68],34,{waypoint:[2.55,3.05,2.15]}),cameraFocus:{enabled:true,focusDistance:.012,focusTarget:"folder-pages"},transition:{duration:4.6,breathing:{...quietBreathing,positionAmplitude:.0012}},responsive:{mobile:{position:[1.78,3.72,.68],lookAt:[1.55,1.26,-.68],fov:42},tablet:{position:[2,3.62,.48],fov:38}},focusCollection:"poems"},
