...
const baseShots = {
  opening:{id:"opening",label:"Opening",route:"/",subject:"room",framing:framing([-.72,1.9,4.82],[-.45,1.42,-.9],42),focus:{enabled:true,focusDistance:.016},transition:{duration:1,breathing:{...quietBreathing,positionAmplitude:.001}},responsive:{mobile:{position:[-.25,2.05,5.6],lookAt:[-.35,1.5,-1.1],fov:49}}},
  workspace:{id:"workspace",label:"Workspace",route:"/",subject:"desk",framing:framing([1.25,2.42,4.25],[-.15,1.42,-1.35],42,{waypoint:[.45,2.3,4.55]}),focus:{enabled:true,focusDistance:.02},transition:{duration:4.8,breathing:quietBreathing},responsive:{mobile:{position:[.4,2.55,5.35],lookAt:[-.1,1.45,-1.35],fov:50}}},
  about:{id:"about",label:"About me",route:"/about",subject:"paper",framing:framing([-1.8,3,-.772],[-2,1.25,-1.022],31,{roll:-25,waypoint:[-1.6,2.85,.16],composition:"readable manuscript"}),focus:{enabled:true,focusDistance:.013,depthOfFieldStrength:0,focusTarget:"paper"},transition:{duration:4.3,breathing:{...quietBreathing,positionAmplitude:.001}},responsive:{mobile:{position:[-1.897,3.16,-.578],fov:46,roll:0}}},
  ...
  certificates:{id:"certificates",label:"Certificates",route:"/certificates",subject:"shelf",framing:framing([-1.15,2.85,.35],[-3.78,2.15,-3.55],39,{waypoint:[-.25,3.05,2.2]}),focus:{enabled:true,focusDistance:.026,focusTarget:"certificate"},transition:{duration:5,breathing:quietBreathing},responsive:{mobile:{position:[-1.65,3.05,1.35],fov:47}}},
...
export const SHOT_REGISTRY:Record<ShotId,Shot> = {
  ...
  "certificate-detail":detail("certificate-detail","Certificate detail","/certificates/:slug","certificates","certificate-detail"),
...
export const GUIDED_SHOT_IDS:ShotId[]=["projects","about","certificates","wall","phone","poems","drawer"];
