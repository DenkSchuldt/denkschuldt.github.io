...
export const CAMERA_TARGETS: Record<CameraTargetId, CameraTarget> = {
  ...
  about: { id:"about", label:"About", position:[-1.8,3,-.772], lookAt:[-2,1.25,-1.022], fov:31, roll:-25, duration:4.3, focusDistance:.013, breathing:{...quietBreathing,positionAmplitude:.001}, waypoint:[-1.6,2.85,.16], responsive:{mobile:{position:[-1.897,3.16,-.578],fov:46,roll:0}} },
