...
export function detectPreliminaryCapabilities(): PreliminaryCapabilities {
  ...
  return {
    ...
    viewportHeight,
    devicePixelRatio,
    estimatedPixelCount: viewportWidth * viewportHeight * Math.min(devicePixelRatio, 1.6) ** 2,
...
export function captureRenderingCapabilities(
  gl: WebGLRenderingContext | WebGL2RenderingContext,
  input: PreliminaryCapabilities,
  resolvedDpr: number,
  ...
  return {
    ...
    maximumTextureUnits: gl.getParameter(gl.MAX_TEXTURE_IMAGE_UNITS),
    maximumAnisotropy: anisotropy ? gl.getParameter(anisotropy.MAX_TEXTURE_MAX_ANISOTROPY_EXT) : 1,
    fragmentPrecision: precision,
