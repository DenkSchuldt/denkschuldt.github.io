export type RenderReason =
  |"navigation-transition"|"camera-settle"|"camera-breathing"|"coffee-steam"
  |"certificate-animation"|"phone-screen"|"poems-preview"|"dof-focus"
  |"projection-sync"|"asset-ready"|"quality-change"|"working-set-change"
  |"resize"|"pointer-interaction"|"visibility-restored"|"effects-settle"
  |"diagnostics-capture"|"initial-render";
...
export interface RenderLease extends Required<Omit<RenderLeaseRequest,"expiresAt"|"lifecycleId"|"metadata">> {
  id:string;
  startedAt:number;
  expiresAt:number|null;
